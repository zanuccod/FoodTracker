...
{
    [TestFixture]
    public class EfFoodDataModelTest
    {
        private EfFoodDataModel dataModel;
        ...
        public void BeforeEachTest()
        {
            var options = new DbContextOptionsBuilder()
                            ...
                            .Options;
            dataModel = new EfFoodDataModel(options);
        }
        ...
        public async Task FindAllAsync()
        {
            ...
            {
                await dataModel.InsertAsync(new Food
                {
                    Id = i,
                    Description = "desc_test_"+i,
                    Name = "name_test_"+i
                }).ConfigureAwait(true);
            }
        ...
        {
            // Arrange
            const string newDesc = "desc_test_2";
            var item = new Food
            {
                Id = 1,
                Description = "desc_test",
            ...
            // Assert
            Assert.AreEqual(newDesc, entity.Description);
            Assert.AreEqual(item, entity);
        }

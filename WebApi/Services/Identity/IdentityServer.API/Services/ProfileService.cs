        ...
        public async Task GetProfileDataAsync(ProfileDataRequestContext context)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(context.Subject.Identity.Name))
                {
                    ...
                    var user = await userDataModel.GetUserAsync(context.Subject.Identity.Name).ConfigureAwait(true);
                    if (user != null)
                    {
                ...
                else
                {
                    ...
                    if (!string.IsNullOrEmpty(username))
                    {
                        ...
                        var user = await userDataModel.GetUserAsync(username).ConfigureAwait(true);
